package com.rakesh.tweeter.Fragments;
...
import com.rakesh.tweeter.Helper.DynamicHeightImageView;
...
public class ComposeTweetFragment extends DialogFragment {
    ...
    public interface ComposeTweetHandler{
    ...
    private ComposeTweetHandler composeTweetHandler;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstance){
        View view = getActivity().getLayoutInflater().inflate(R.layout.compose_tweet, container);
        ...
        etTweet.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (s.length() > 140) {
                    ...
                    tvTweetLength.setTextColor(Color.WHITE);
                    length = s.length();
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof ComposeTweetHandler) {
            composeTweetHandler = (ComposeTweetHandler) context;
        } else {
